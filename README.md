...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,avascript,bootstrap,vite,ts,next,expressjs,nodejs,mongodb,mysql,firebase,md,git,github,linux,vscode,vim,sublime,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
