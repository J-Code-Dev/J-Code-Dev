...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,javascript,sass,bootstrap,vite,ts,next,expressjs,nodejs,npm,mongodb,mysql,aws,azure,figma,firebase,md,git,github,linux,vscode,vim,sublime,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
