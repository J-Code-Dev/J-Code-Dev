...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,javascript,react,vite,ts,next,expressjs,nodejs,mongodb,mysql,firebase,md,git,github,vscode,vim,sublime,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
