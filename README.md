...
[![My Skills](https://skillicons.dev/icons?i=html,css,tailwind,javascript,bootstrap,vite,ts,next,expressjs,nodejs,mongodb,mysql,aws,azure,firebase,md,git,github,linux,vscode,vim,sublime,jest,styledcomponents,postman,stackoverflow&perline=13)](#)
